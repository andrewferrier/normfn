...
class TestDirectFrozenTime(NormalizeFilenameTestCase):
    ...
    def test_basicdateprefix(self) -> None:
        ...
        self.assertTrue((self.working_dir / "2015-02-03-blah.txt").exists())
    ...
    def test_basicdateprefix_add_time(self) -> None:
        ...
        self.assertFalse(filename.exists())
        self.assertTrue((self.working_dir / "2015-02-03T10-11-12-blah.txt").exists())
        self.assertEqual(1, self.directory_file_count(self.working_dir))
        self.assertEqual("", error)
    ...
    def test_ok_behind(self) -> None:
        ...
        self.assertFalse(filename.exists())
        self.assertTrue((self.working_dir / "1990-02-03-blah.txt").exists())
        self.assertEqual(1, self.directory_file_count(self.working_dir))
        self.assertEqual("", error)
    ...
    def test_ok_ahead(self) -> None:
        ...
        error = self.invoke_directly([filename])
        self.assertFalse(filename.exists())
        self.assertTrue((self.working_dir / "2019-02-03-blah.txt").exists())
        self.assertEqual(1, self.directory_file_count(self.working_dir))
        self.assertEqual("", error)
    ...
    def test_toofar_behind(self) -> None:
        ...
        error = self.invoke_directly([filename], extra_params=["--now"])
        self.assertFalse(filename.exists())
        self.assertTrue((self.working_dir / "2015-04-05-blah-1970-02-03.txt").exists())
        self.assertEqual(1, self.directory_file_count(self.working_dir))
        self.assertEqual("", error)
    ...
    def test_toofar_ahead(self) -> None:
        ...
        error = self.invoke_directly([filename], extra_params=["--now"])
        self.assertFalse(filename.exists())
        self.assertTrue((self.working_dir / "2015-04-05-blah-2025-02-03.txt").exists())
        self.assertEqual(1, self.directory_file_count(self.working_dir))
        self.assertEqual("", error)
    ...
    def test_ok_ahead_adjusted(self) -> None:
        ...
        self.assertFalse(filename.exists())
        self.assertTrue((self.working_dir / "2025-02-03-blah.txt").exists())
        self.assertEqual(1, self.directory_file_count(self.working_dir))
        self.assertEqual("", error)
    ...
    def test_ok_behind_adjusted(self) -> None:
        ...
        self.assertFalse(filename.exists())
        self.assertTrue((self.working_dir / "1970-02-03-blah.txt").exists())
        self.assertEqual(1, self.directory_file_count(self.working_dir))
        self.assertEqual("", error)
    ...
    def test_toofar_ahead_adjusted(self) -> None:
        ...
        self.assertFalse(filename.exists())
        self.assertTrue((self.working_dir / "2015-04-05-blah-2200-02-03.txt").exists())
        self.assertEqual(1, self.directory_file_count(self.working_dir))
        self.assertEqual("", error)
    ...
    def test_toofar_behind_adjusted(self) -> None:
        ...
        self.assertFalse(filename.exists())
        self.assertTrue((self.working_dir / "2015-04-05-blah-1930-02-03.txt").exists())
        self.assertEqual(1, self.directory_file_count(self.working_dir))
        self.assertEqual("", error)
    ...
    def test_addtime(self) -> None:
        ...
        error = self.invoke_directly([filename], extra_params=["--add-time", "--now"])
        self.assertFalse(filename.exists())
        self.assertTrue((self.working_dir / "2015-04-05T10-11-12-blah.txt").exists())
        self.assertEqual(1, self.directory_file_count(self.working_dir))
        self.assertEqual("", error)
