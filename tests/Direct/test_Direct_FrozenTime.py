...
class TestDirectFrozenTime(NormalizeFilenameTestCase):
    ...
    def test_ok_behind(self):
        ...
        self.assertFalse(os.path.exists(filename))
        self.assertTrue(os.path.exists(os.path.join(self.workingDir, '1990-02-03-blah.txt')))
        self.assertEqual(1, self.directoryFileCount(self.workingDir))
        self.assertEqual('', error)
    ...
    def test_ok_ahead(self):
        ...
        error = self.invokeDirectly([filename])
        self.assertFalse(os.path.exists(filename))
        self.assertTrue(os.path.exists(os.path.join(self.workingDir, '2019-02-03-blah.txt')))
        self.assertEqual(1, self.directoryFileCount(self.workingDir))
        self.assertEqual('', error)
    ...
    def test_toofar_behind(self):
        ...
        error = self.invokeDirectly([filename], extraParams=['--now'])
        self.assertFalse(os.path.exists(filename))
        self.assertTrue(os.path.exists(os.path.join(self.workingDir, '2015-04-05-blah-1970-02-03.txt')))
        self.assertEqual(1, self.directoryFileCount(self.workingDir))
        self.assertEqual('', error)
    ...
    def test_toofar_ahead(self):
        ...
        error = self.invokeDirectly([filename], extraParams=['--now'])
        self.assertFalse(os.path.exists(filename))
        self.assertTrue(os.path.exists(os.path.join(self.workingDir, '2015-04-05-blah-2025-02-03.txt')))
        self.assertEqual(1, self.directoryFileCount(self.workingDir))
        self.assertEqual('', error)
    ...
    def test_ok_ahead_adjusted(self):
        filename = os.path.join(self.workingDir, 'blah-2025-02-03.txt')
        self.touch(filename)
        error = self.invokeDirectly([filename], extraParams=['--now', '--max-years-ahead=50'])
        self.assertFalse(os.path.exists(filename))
        self.assertTrue(os.path.exists(os.path.join(self.workingDir, '2025-02-03-blah.txt')))
        self.assertEqual(1, self.directoryFileCount(self.workingDir))
        self.assertEqual('', error)
    ...
    def test_ok_behind_adjusted(self):
        filename = os.path.join(self.workingDir, 'blah-1970-02-03.txt')
        self.touch(filename)
        error = self.invokeDirectly([filename], extraParams=['--now', '--max-years-behind=50'])
        self.assertFalse(os.path.exists(filename))
        self.assertTrue(os.path.exists(os.path.join(self.workingDir, '1970-02-03-blah.txt')))
        self.assertEqual(1, self.directoryFileCount(self.workingDir))
        self.assertEqual('', error)
    ...
    def test_toofar_ahead_adjusted(self):
        ...
        error = self.invokeDirectly([filename], extraParams=['--now', '--max-years-ahead=50'])
        self.assertFalse(os.path.exists(filename))
        self.assertTrue(os.path.exists(os.path.join(self.workingDir, '2015-04-05-blah-2200-02-03.txt')))
        self.assertEqual(1, self.directoryFileCount(self.workingDir))
        self.assertEqual('', error)
